...
\title[B2OC]{Model-independent measurement of \texorpdfstring{$\gamma$}{gamma} using \texorpdfstring{$B^\pm\to[h^+h^-\pi^+\pi^-]_Dh^\pm$}{B2DhD2hhpipi} decays}
...
\begin{frame}{Previous studies of $\gamma$ with $B^\pm\to DK^\pm$, $D\to\pi^+\pi^-\pi^+\pi^-$}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      ...
      \item{Joint effort between Oxford and Bristol group using a new, optimal binning schem}
    \end{itemize}
  \end{enumerate}
\end{frame}
